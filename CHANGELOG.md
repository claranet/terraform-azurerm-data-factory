...
* **SREAA-368:** upgrade module to v9 (OpenTofu >= 1.12, AzureRM ~> 5.0) 89aedfe

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.5 4a0c97e
* **deps:** update dependency tflint to v0.64.0 fa45adc
* **SREAA-368:** synchronize committed.toml and AGENTS.md from the ci template 2c778cc
* **v9:** 🐛 synchronize common files and docs 2174c48

## 8.1.5 (2026-07-20)

### Bug Fixes

* **tflint:** 🐛 bump Azure rules version, fix signature bug 317be05

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 a1ea5f2
* **deps:** update dependency opentofu to v1.12.2 7a4af38
* **deps:** update dependency opentofu to v1.12.3 c2964e0
* **deps:** update dependency opentofu to v1.12.4 bc9c1cf
* **deps:** update dependency tflint to v0.63.1 3dad061
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 a50845f
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 3ce1534

## 8.1.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ a02cd52

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 612ff20
* **deps:** update dependency opentofu to v1.11.7 ccd8e12
* **deps:** update dependency opentofu to v1.12.0 891f835
* **deps:** update dependency terraform-docs to v0.23.0 922c765
* **deps:** update dependency terraform-docs to v0.24.0 0a9f246
* **deps:** update dependency tflint to v0.62.1 ed3ccb3
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 40a9a1c
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 f693688
* **deps:** update tools c99734d
* **pre-commit:** 🔧 move to prek 7ae63d2
* **tfdocs:** bump tfdocs to v0.22 🔧 7e961ab

## 8.1.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 5357811

### Code Refactoring

* update module structure and Github actions 👷 1686cf9

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 90f1d6b
* **deps:** 🔗 bump tflint rules version 8cbdaea
* **deps:** update dependency trivy to v0.69.2 58c124d
* **deps:** update dependency trivy to v0.69.3 858683c
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 c9cbc9f

## 8.1.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 0eaa4e0

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 c15f33a
* **deps:** update dependency opentofu to v1.11.2 8742299
* **deps:** update dependency opentofu to v1.11.3 8a1408d
* **deps:** update dependency opentofu to v1.11.4 30f25b3
* **deps:** update dependency opentofu to v1.11.5 05966f1
* **deps:** update dependency pre-commit to v4.4.0 eb54339
* **deps:** update dependency pre-commit to v4.5.0 e36c25e
* **deps:** update dependency pre-commit to v4.5.1 0040b74
* **deps:** update dependency tflint to v0.60.0 fbcc2a9
* **deps:** update dependency tflint to v0.61.0 8cc142d
* **deps:** update dependency trivy to v0.67.1 e7fa7ab
* **deps:** update dependency trivy to v0.67.2 89c45c1
* **deps:** update dependency trivy to v0.68.1 3295054
* **deps:** update dependency trivy to v0.68.2 b48ca92
* **deps:** update dependency trivy to v0.69.0 8851eed
* **deps:** update dependency trivy to v0.69.1 bbe7d14
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 c8630a1
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 8d5f6bc
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 6994f09
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 e5b70ed
* **deps:** update tools b579d6e
