locals {
  ...
  self_hosted_integration_runtime_primary_auth_key   = try(azurerm_data_factory_integration_runtime_self_hosted.integration_runtime[0].auth_key_1, null)
  self_hosted_integration_runtime_secondary_auth_key = try(azurerm_data_factory_integration_runtime_self_hosted.integration_runtime[0].auth_key_2, null)
